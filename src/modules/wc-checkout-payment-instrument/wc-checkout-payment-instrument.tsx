...
import { AsyncResultStatusCode } from './components/common';
import { AddPaymentFormComponent } from './components/common/add-payment-form';
...
} from './components/common/payment-instrument-message';
import { WaitingComponent } from './components/common/waiting';
import { IVisibilityObserverProps, withVisibilityObserver } from './components/common/with-visibility-observer';
import getCardPaymentAcceptPointAction, { GetCardPaymentAcceptPointInput } from './actions/get-card-payment-accept-point';
import { IWcCheckoutPaymentInstrumentData } from './wc-checkout-payment-instrument.data';
import { IWcCheckoutPaymentInstrumentProps } from './wc-checkout-payment-instrument.props.autogenerated';
import PaymentInformationComponent from './components/payment-information';

export interface IWcCheckoutPaymentInstrumentModuleProps
    extends IWcCheckoutPaymentInstrumentProps<IWcCheckoutPaymentInstrumentData>,
        IModuleStateProps,
...
export interface IWcCheckoutPaymentInstrumentViewProps extends IWcCheckoutPaymentInstrumentProps<{}>, ICheckoutPaymentInstrumentState {
    className?: string;
 ...
 * @extends {React.Component<IWcCheckoutPaymentInstrumentProps<IWcCheckoutPaymentInstrumentData>>}
 */
// @ts-expect-error
@withModuleState
@observer
export class CheckoutPaymentInstrument extends React.PureComponent<IWcCheckoutPaymentInstrumentModuleProps> {
    ...
    public render(): JSX.Element | null {
        ...
        const viewProps: IWcCheckoutPaymentInstrumentViewProps = {
            ...this.props,
            ...this.state,
            isVisible,
            className,
    ...
    private readonly handlePaymentResult = (resultAccessCode: string, isRedirectedFromPaymentGateway: boolean = false): void => {
        ...
        retrieveCardPaymentAcceptResultAsync({ callerContext: this.props.context.actionContext }, resultAccessCode, [], cartId, settings)
            ...
            .catch(error => {
                // IMPORTANT: Call RS for getting a new payment session. It should not re-use the previous session for the security reason.
                void this.updatePaymentAcceptPageData();
                this.setTerminalError(error);
            })
            .finally(() => {
                this.setState({
    ...
    private readonly onContainerReady = (): void => {
        void this.redirectToPaymentVerification();
